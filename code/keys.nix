...
let
  ...
  leaders = [
    ...
    {
      key = "<leader>D";
      action = "<cmd>Telescope show_workspace_diagnostics<CR>";
      options.desc = "Open workspace diagostic picker";
    }
    {
      key = "<leader>F";
    ...
    }
    {
      ...
      options.desc = "Open diagostic picker";
    }
    {
      key = "<leader>f";
      action = "<cmd>lua MiniFiles.open()<CR>";
  ...
  movements = [
    ...
    }
    {
      key = "ge";
      action = "G";
      options.desc = "Goto file bottom";
    }
    {
      key = "gf";
      action = "gf";
      options.desc = "Goto files";
    }
    {
      key = "gg";
      action = "gg";
      options.desc = "Goto file start";
    }
    {
      key = "gh";
      action = "0";
